...
export const metadata = {
  title: 'Multiinmuebles - Bienes Raíces en Quetzaltenango | Compra, Venta y Arrendamiento',
  description: 'Encuentra tu propiedad ideal en Quetzaltenango. Más de 120 propiedades verificadas, 10+ años de experiencia. Casas, apartamentos, terrenos y locales comerciales.',
  keywords: 'inmobiliaria Quetzaltenango, propiedades Xela, casas en venta Guatemala, apartamentos Quetzaltenango, bienes raíces Guatemala',
  openGraph: {
    title: 'Multiinmuebles - Tu Hogar en Quetzaltenango',
    description: 'Más de 120 propiedades verificadas. 10+ años liderando el mercado inmobiliario.',
  ...
  twitter: {
    ...
    title: 'Multiinmuebles - Bienes Raíces en Quetzaltenango',
    description: 'Encuentra tu propiedad ideal. Más de 120 opciones disponibles.',
  },
  alternates: {
    canonical: 'https://multiinmuebles.com',
  },
};
...
export default async function Home() {
  ...
  try {
    ...
    featuredProperties = data?.map(prop => ({
      id: prop.id,
      title: prop.titulo,
      price: prop.precio,
      location: prop.ubicacion,
      image: prop.header_image || null,
      area: prop.metros2,
  ...
  return (
    <main className="space-y-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="card-service p-8 rounded-2xl shadow-lg hover:shadow-2xl group transition-all duration-300"
                >
                  <div className="flex items-center justify-center mb-6">
                    <div className="w-16 h-16 bg-gradient-cta rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-naranja">
                      <Icon className="w-8 h-8 text-blanco" aria-hidden="true" />
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-naranja/10 border border-naranja/30 rounded-full px-6 py-2 mb-6">
              <HomeIcon className="w-5 h-5 text-naranja" aria-hidden="true" />
          ...
          {error ? (
            <div className="text-center py-16">
              <div className="inline-flex items-center gap-3 bg-red-50 border-2 border-red-200 rounded-xl px-6 py-4 text-red-800 font-semibold">
                <span>⚠️ Error cargando propiedades. Intenta más tarde.</span>
              </div>
            </div>
          ) : featuredProperties.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-xl text-gris-oscuro/70 mb-6">
                No hay propiedades disponibles en este momento
              </p>
              <Link href="/contacto">
                <button className="btn-cta px-6 py-3 rounded-lg font-semibold shadow-naranja hover:scale-105 transition-transform">
      ...
      <section 
        ...
        aria-label="Estadísticas de Multiinmuebles"
      >
        {/* Decoración de fondo */}
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none" aria-hidden="true">
          ...
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-blanco rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
                  ...
                  <CardContent className="p-8 text-center">
                    <div className="flex items-center justify-center mb-6">
                      <div className="w-20 h-20 bg-blanco/20 backdrop-blur-lg rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Icon className="w-10 h-10 text-amarillo-dorado" aria-hidden="true" />
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-gris-claro to-blanco border-4 border-naranja rounded-3xl p-12 shadow-2xl text-center">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-cta rounded-full mb-8 shadow-naranja">
              <Phone className="w-10 h-10 text-blanco" aria-hidden="true" />
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-naranja flex-shrink-0 mt-1" aria-hidden="true" />
                <div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Multiinmuebles",
            "description": "Inmobiliaria líder en Quetzaltenango con más de 10 años de experiencia",
            "url": "https://multiinmuebles.com",
            "logo": "https://multiinmuebles.com/images/Icon.png",
            "telephone": "+502-5556-6379",
            "address": {
              "@type": "PostalAddress",
            ...
            "sameAs": [
              "https://www.facebook.com/multiinmuebles1",
              "https://www.instagram.com/multiinmuebles"
            ],
            "aggregateRating": {
